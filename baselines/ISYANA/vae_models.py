...
class AutoEncoder(Replayer):
    ...
    def __init__(self, image_size, image_channels, classes,
        ...
        if 'cifar' in data_name:
            ...
            ninputs = image_channels*image_size**2
            noutputs = image_channels*image_size**2
        self.fcE = MLP(input_size=ninputs, output_size=fc_units, layers=fc_layers-1,
        ...
        # -fully connected hidden layers
        self.fcD = MLP(input_size=fc_units, output_size=noutputs, layers=fc_layers-1,
    ...
    def classify(self, x):
        ...
        _, hE = self.fcE(self.flatten(x)) ###--Revised
    ...
    def decode(self, z):
        ...
        hD = self.fromZ(z)
        _, image_features = self.fcD(hD)
        image_recon = image_features
        if not self.resnet18:
