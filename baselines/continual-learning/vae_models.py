...
class AutoEncoder(Replayer):
    ...
    def __init__(self, image_size, image_channels, classes,
        ...
        self.fcE = MLP(input_size=image_channels*image_size, output_size=fc_units, layers=fc_layers-1,
        ...
        # -fully connected hidden layers
        self.fcD = MLP(input_size=fc_units, output_size=image_channels*image_size, layers=fc_layers-1,
